...
def summary_model(model_folder):
    ...
    for subdir in subdirectories:
        ...
        if not os.path.exists(elite):
            print(f"Warning: elite.json file not found in {kartezio_model}. Skipping this subdirectory.")
            continue
        ...
        res = SummaryModel(params, fitness, endpoint, mode, nodes, sequence, functions, kartezio_model)
        print(res.template())
