...
\begin{minted}[fontsize=\small,frame=lines,bgcolor=blue!4]{text}
dataset/
│── train/
│   │── train_x/
...
\begin{minted}[bgcolor=blue!4,fontsize=\small,mathescape,tabsize=4, escapeinside=||, breaklines]{python}
...
\begin{minted}[bgcolor=blue!4,breaklines,fontsize=\footnotesize]{python}
...
\red{
    graphiques a faire et changer les exemples dans le texte pour coller avec les graphes
}
...
\cleardoublepage
\chapter{Étude et reparamétrisation d'un modèle de fondation}
\red{nouvelle partie}
...
\subsection{hyperparamètres}\label{sec:hyperparameters}
